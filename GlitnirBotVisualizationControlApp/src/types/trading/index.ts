...
export interface Candle {
    ...
    trades: number;
    //_______part specific to real time feed candle
    eventTime?: number,
    buyVolume?: number,
...
//___________________________buy sell signals
...
//_________________________________trailing data
