...
function setMarkers(
    ...
    for (const markerName of CHART_MARKERS_NAMES) {
        markersStateSetters[markerName](data[markerName] || []);
    }
}
...
function createSetModifier(
    ...
    return (data: IFeedData) => {
        // ______________________________ set tick candles
        seriesRef.current.tickCandles.setData(data.tickCandles);
...
export const KidoLightChart = ({
    ...
    const markersStateSetters: MarkersStateSetters = {
        firstSigNoDoubleSignals: setFirstSigNoDoubleSignals,
        closeSigNoDoubleSignals: setCloseSigNoDoubleSignals,
        mainSignals: setMainSignals
    };
    ...
    useEffect(() => {
        ...
        // ___________ creating tick candles stick series
        seriesRef.current.tickCandles = chartRef.current.addCandlestickSeries({
