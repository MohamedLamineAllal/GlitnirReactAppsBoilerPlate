...
import { IDataVisualizationBoxProps, IDataVisualizationBox } from '../interface';
...
export function createComponent({
    ...
    return ({
        ...
        return <CandleStickChart  // TODO: later the chart component will get more complicated We
