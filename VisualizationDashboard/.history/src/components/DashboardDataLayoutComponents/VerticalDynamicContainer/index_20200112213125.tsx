...
import { useStateWithGet } from '../../../customHooks/useStateWithGet';
...
async function dataFeedResolver(
    data: DataFeed,
    getComponentsRefBySignature: () => ComponentRefs,
    ...
    console.log("DATA =) ===")
    console.log(data)
    const componentsRefBySignature = getComponentsRefBySignature();

    for (const signature of Object.keys(data)) {
        console.log("Signature ::: " + signature + " : ::::");
        dataFeed = data[signature];
        componentRef = [signature];
        ...
        if (componentRef) {
             ...
             */
            console.log({
                componenettypeidentifier: dataFeed.componentTypeIdentifier,
                payload: dataFeed.payload,
                isCustom: dataFeed.isCustom
            })
...
export function VerticalDynamicContainer({
    ...
    const [
        componentsRefBySignature,
        setComponentsRefBySignature,
        getComponentsRefBySignature
    ] = useStateWithGet<ComponentRefs>({});
