...
export type UseStateWithGetReturn<StateType> = [
    StateType,
    (state: SetStateCallback<StateType> | StateType) => void,
    () => StateType
];
 ...
 * @returns
 */
export function useStateWithGet<StateType = any>(initialState: StateType): UseStateWithGetReturn<StateType> {
 ...
 * @returns
 */
export function useStateWithGetEf<StateType = any>(initialState: StateType): UseStateWithGetReturn<StateType> {
